...
function doPost(event) {
    try {
      ...
      var majorsheetId = "<your-major-database-spreadsheetid>"; // Replace with your actual Google Sheet ID
  ...
  function gcalMaker(rowtopush, calendar_name){
    ...
    all_cal_names ={
      "notioncal" :"<gcal-id1>",
      "deadlinecal" : "<gcal-id3>",
      "remindercal" : "<gcal-id3>"
    }
  ...
  function gsheetPusher(rowtopush){
    ...
    const spreadsheetId = '<your-minor-database-spreadsheetid>'; // Replace with your Google Sheets file ID
